...
BONUS_TEXT = os.getenv("BONUS_TEXT", """🎉 Подтверждено: ты теперь в модной элите M_Kapusssta.

🎁 Твой <b>секретный промокод</b>: <code>BONU$25</code>  
💸 Скидка 10% на любую покупку — потому что ты не просто носишь вещи. Ты создаёшь вайб.

📅 Промокод активен 7 дней.  
Потом он исчезнет, как последний размер на лимитированной коллекции.

🛍 Переходи в каталог, выбирай то, что говорит за тебя, и применяй промокод при заказе.

Ты не просто покупаешь одежду. Ты собираешь восхищённые взгляды.""")
...
Подписка на @m_kapusssta — это как подписка на стильную телепортацию:
